...
public sealed record CommunityDeviceStrategyEntry
{
    public int SchemaVersion { get; init; } = 1;

    public string EntryId { get; init; } = Guid.NewGuid().ToString("N");

    public string Name { get; init; } = "Community Device Strategy";
    ...
    public DeviceStrategyPackage Package { get; init; } = new();
}
